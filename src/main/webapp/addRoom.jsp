...
<input type="text" name="roomType" class="form-control" placeholder="e.g. Deluxe, Suite" required>
</div>

<div class="mb-3">
<label class="form-label">Price (₹ / night)</label>
<input type="number" name="price" class="form-control" placeholder="e.g. 3499" required>
</div>
...
<button class="btn-submit" type="submit">Add Room</button>
